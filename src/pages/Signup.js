...
const Signup = () => {
  ...
  const { email, isLoading, isError } = useSelector((state) => state.auth);
  ...
  useEffect(() => {
    ...
    if (isLoading) {
      toast.loading("Loading...", { id: "create-user" });
    }
    if (isError && !isLoading) {
      toast.error("something went wrong!", { id: "create-user" });
    }
  }, [email, isLoading, isError, navigate]);
